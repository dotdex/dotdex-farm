...
import "./DotDexToken.sol";
import "./DotDexStake.sol";
...
// DotDexFarm is the master of Astro. He can make Astro and he is a fair guy.
//
...
contract DotDexFarm is Ownable {
    ...
    // The CAKE TOKEN!
    DotDexToken public cake;
    // The SYRUP TOKEN!
    DotDexStake public syrup;
    // Dev address.
    ...
    // Deposit LP tokens to DotDexFarm for Astro allocation.
    ...
    // Withdraw LP tokens from DotDexFarm.
    ...
    // Stake Astro tokens to DotDexFarm
