...
contract DotDexStake is BEP20("DotDexStake Token", "DotDexStake", 18) {
    using SafeMath for uint256;
    mapping(address => bool) public isOperator;

    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (DotDexFarm).
    ...
    constructor(DotDexToken _cake) public {
        cake = _cake;
