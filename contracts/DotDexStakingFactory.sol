...
import "./DotDexStakingPoolInitializable.sol";

contract DotDexStakingFactory is Ownable {
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(DotDexStakingPoolInitializable)
            .creationCode;
        ...
        DotDexStakingPoolInitializable(sousChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerSecond,
            _startTimestamp,
